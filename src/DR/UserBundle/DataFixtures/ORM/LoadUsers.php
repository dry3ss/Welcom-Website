...
class LoadUsers implements FixtureInterface, ContainerAwareInterface
{
	...
	private function loadUsers(ObjectManager $manager)
	{
		...
		$encodedPassword = $passwordEncoder->encodePassword($johnUser, 'kittyThisIsNotTheRealPassword...');
		...
		$encodedPassword = $passwordEncoder->encodePassword($annaAdmin, 'kittyThisIsNotTheRealPassword...');
		...
		$encodedPassword = $passwordEncoder->encodePassword($TomSAdmin, 'kittyThisIsNotTheRealPassword...');
