...
class News
{
    ...
    */
     ...
     * Set partoftrinews
     *
     * @param boolean $partoftrinews
     *
     * @return News
     */
    public function setPartoftrinews($partoftrinews)
    {
        $this->partoftrinews = $partoftrinews;
     ...
     * @return boolean
     */
    public function getPartoftrinews()
    {
        return $this->partoftrinews;
    }
